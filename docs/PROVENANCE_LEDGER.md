...
| Stage 4B-1 GitHub Strands/ledger integration                                                  | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4B-0 on the same local branch; publication requires clean verification, live-path evidence, diff review, and successor CI.       |
| Stage 4B-2 deployment-marker collector                                                        | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4B-1; publication requires clean verification, diff review, and successor CI. No live deployment evidence exists.                |
| Stage 4B-3 interactive live release verifier                                                  | `ELIGIBLE_FOR_REVIEW` | Newly authored on `codex/clarify-core`; publication requires full verification, live read-only evidence, browser review, diff review, and successor CI.      |
| Stage 4C-1a public-demo decision boundary                                                     | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4B-2; publication requires clean verification, headed-browser evidence, diff review, and successor CI. No hosting occurred.      |
| Stage 4C-1b host, platform-port, and health boundary                                          | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4C-1a; publication requires clean verification, process-probe evidence, diff review, and successor CI. No hosting occurred.      |
| Stage 4C-1c exact-commit release-marker route                                                 | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4C-1b; publication requires clean verification, exact-HEAD process evidence, diff review, and successor CI. No hosting occurred. |
| Stage 4C-1d persistent database-path boundary                                                 | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4C-1c; publication requires clean verification, restart-persistence evidence, diff review, and successor CI. No volume exists.   |
| Stage 4C-1e deterministic production-start command                                            | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4C-1d; publication requires clean verification, actual start-process evidence, diff review, and successor CI. No hosting occurred. |
| Stage 4C-1f Railway configuration boundary                                                    | `ELIGIBLE_FOR_REVIEW` | Newly authored after Stage 4C-1e; publication requires schema validation, local process evidence, diff review, and successor CI. No Railway resource exists.   |
